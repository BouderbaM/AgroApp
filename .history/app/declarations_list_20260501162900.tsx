...
/* ================= CARD COMPONENT ================= */
const DeclarationCard = ({ item, router, getUserData, getColor }: any) => {
  ...
  return (
    <View style={styles.card}>
      ...
      <Text style={styles.text}>
        👤 {owner ? owner.nom + " " + owner.prenom : "Chargement..."}
      </Text>

      <Text style={styles.text}>📞 {owner?.phone || "Non disponible"}</Text>
