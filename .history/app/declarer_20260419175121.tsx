  ...
  return (
    <SafeAreaView style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        {/* تصميم حاوية الـ Picker ليتناسب مع شكل الـ Input */}
        <View style={styles.pickerContainer}>
          <Picker
            ...
            mode="dropdown" // خاص بالأندرويد لإظهاره كقائمة منسدلة
          >
            <Picker.Item
              label="Sélectionnez une wilaya"
              value=""
              color="#8E949A"
            />
            {wilayas.map((w) => (
              <Picker.Item key={w} label={w} value={w} color="#000000" />
            ))}
          </Picker>
        </View>
