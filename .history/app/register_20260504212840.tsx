    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        <ScrollView contentContainerStyle={styles.scrollContent}>
          ...
          <Text style={styles.label}>
            Mot de passe <Text style={{ color: "red" }}>*</Text>
          </Text>
          <TextInput
            style={styles.input}
            secureTextEntry
          ...
          {/* COMMUNE */}
          <Text style={styles.label}>
            Commune <Text style={{ color: "red" }}>*</Text>
          </Text>
          <TextInput
            style={styles.input}
          ...
          <View style={styles.footer}>
            <Text style={styles.footerText}>vous avez déja compte ?</Text>
...
const styles = StyleSheet.create({
  ...
  header: {
    ...
    justifyContent: "center", // centre vertical (si hauteur définie)
  },
