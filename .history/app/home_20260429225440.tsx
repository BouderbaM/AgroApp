...
const HomeScreen = () => {
  ...
  const fetchStatistics = async () => {
    try {
      ...
      console.log("Fetching stats for UID:", user.uid);
      ...
      // هذا السطر سيطبع لك الرابط الذي تحتاجه لإنشاء الـ Index إذا كان مفقوداً
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.aboutCard}>
          ...
          <Text style={styles.aboutText}>
            PhytoCycle est une plateforme de gestion du recyclage des bidons de
