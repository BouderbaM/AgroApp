    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        <ScrollView contentContainerStyle={styles.scrollContent}>
          ...
          {/* PRENOM */}
          <Text style={styles.label}>
            Prénom <Text style={styles.asterisk}>*</Text>
          </Text>
          <TextInput
            style={styles.input}
            value={form.prenom}
          ...
          {/* NOM */}
          <Text style={styles.label}>
            Nom <Text style={styles.asterisk}>*</Text>
          </Text>
          <TextInput
            style={styles.input}
            value={form.nom}
          ...
          {/* PHONE */}
          <Text style={styles.label}>
            Téléphone <Text style={styles.asterisk}>*</Text>
          </Text>
          <TextInput
            style={styles.input}
            value={form.phone}
          ...
          {/* COMMUNE */}
          <Text style={styles.label}>
            Commune <Text style={styles.asterisk}>*</Text>
          </Text>
          <TextInput
            style={styles.input}
            value={form.commune}
          ...
          {/* Adresse */}
          <Text style={styles.label}>
            Adresse <Text style={styles.asterisk}>*</Text>
          </Text>
          <TextInput
            style={styles.input}
            value={form.adresse}
