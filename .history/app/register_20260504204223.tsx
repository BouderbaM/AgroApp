...
export default function Register() {
  ...
  const validateForm = () => {
    ...
    if (form.raison_social && !frenchRegex.test(form.raison_social))
    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        >
          ...
          <Label title="Raison social" />
          <TextInput
            style={styles.input}
            value={form.raison_social}
            onChangeText={(text) => setForm({ ...form, raison_social: text })}
          ...
          <View style={styles.footer}>
            ...
            <TouchableOpacity onPress={() => router.push("/login")}>
              <Text style={styles.linkText}>Connecter</Text>
            </TouchableOpacity>
          </View>
          ...
          <Modal visible={showWilaya} transparent animationType="fade">
            <View style={styles.modalOverlay}>
              <View style={styles.modalContent}>
                ...
                <TouchableOpacity onPress={() => setShowWilaya(false)}>
                  <Text
                    style={{ color: "red", textAlign: "center", marginTop: 10 }}
                  >
                    Fermer
