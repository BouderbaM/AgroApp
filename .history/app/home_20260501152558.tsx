      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.chartCard}>
          ...
          <View style={styles.barRow}>
            <Text style={styles.barLabel}>Bon</Text>
            <View style={styles.barBg}>
              <View
                style={[
                  styles.barFill,
                  {
                    width: `${stats.total ? (stats.bon / stats.total) * 100 : 0}%`,
                    backgroundColor: "#4caf50",
                  },
                ]}
              />
            </View>
            <Text style={styles.barValue}>{stats.bon}</Text>
          </View>

          {/* ÉCRASÉ */}
          <View style={styles.barRow}>
            <Text style={styles.barLabel}>Écrasé</Text>
            <View style={styles.barBg}>
              <View
                style={[
                  styles.barFill,
                  {
                    width: `${stats.total ? (stats.ecrase / stats.total) * 100 : 0}%`,
                    backgroundColor: "#ffc107",
                  },
                ]}
              />
            </View>
            <Text style={styles.barValue}>{stats.ecrase}</Text>
          </View>

          {/* ENDOMMAGÉ */}
          <View style={styles.barRow}>
            <Text style={styles.barLabel}>Endommagé</Text>
            <View style={styles.barBg}>
              <View
                style={[
                  styles.barFill,
                  {
                    width: `${stats.total ? (stats.endommage / stats.total) * 100 : 0}%`,
                    backgroundColor: "#ef4444",
                  },
                ]}
              />
            </View>
            <Text style={styles.barValue}>{stats.endommage}</Text>
          </View>
        </View>
        {/* Button */}
        <TouchableOpacity
