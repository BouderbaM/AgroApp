...
const styles = StyleSheet.create({
  ...
  pickerContainer: {
    backgroundColor: "#121414", // استخدم نفس لون خلفية تطبيقك بدلاً من الأسود الصرف إذا أردت
    borderWidth: 1,
    borderColor: "#2D3135",
    borderRadius: 8,
    overflow: "hidden",
    justifyContent: "center", // لضمان توسيط العنصر داخل الحاوية
  },
  picker: {
    color: "#FFFFFF",
    height: 52,
    backgroundColor: "transparent", // تأكد أنه شفاف ليظهر لون الـ Container
  },
  policyCard: {
    flexDirection: "row",
