      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <View style={styles.infoCard}>
          ...
          <View style={[styles.infoRow, styles.borderTop]}>
            ...
            <Text style={[styles.infoValue, { color: '#4CAF50', textTransform: 'capitalize' }]}>
              {user?.role || "..."}
            </Text>
          </View>
        </View>
        ...
        <View style={styles.settingCard}>
          ...
          <View style={styles.languageToggle}>
            <TouchableOpacity 
              style={[styles.langBtn, language === "Français" && styles.langBtnActive]}
              onPress={() => setLanguage("Français")}
            >
              <Text style={[styles.langText, language === "Français" && styles.langTextActive]}>Français</Text>
            </TouchableOpacity>
            <TouchableOpacity 
              style={[styles.langBtn, language === "العربية" && styles.langBtnActive]}
              onPress={() => setLanguage("العربية")}
            >
              <Text style={[styles.langText, language === "العربية" && styles.langTextActive]}>العربية</Text>
            </TouchableOpacity>
          </View>
        </View>
        ...
        <View style={styles.settingCard}>
          <View style={styles.rowBetween}>
            ...
            <View style={styles.row}>
              <Text style={[styles.statusText, { color: notificationsEnabled ? '#4CAF50' : '#8E949A' }]}>
