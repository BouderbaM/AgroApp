...
export default function Register() {
  ...
  const handleRegister = async () => {
    ...
    if (!phoneRegex.test(phone)) {
      Alert.alert(
        "Erreur",
        "Le téléphone doit contenir au moins 10 chiffres et commencer par 05, 06 ou 07.",
      );
      return;
    }
    ...
    if (!passwordRegex.test(password)) {
      Alert.alert(
        "Erreur",
        "Le mot de passe doit contenir au moins 8 caractères (un mélange de lettres et de chiffres).",
      );
      return;
    }
