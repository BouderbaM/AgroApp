...
// 1. تعريف أنواع الشاشات داخل الـ Navigator
...
// 2. تعريف أنواع الـ Props للشاشة الحالية
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.card}>
          <Text style={styles.cardMainText}>
            ...
            fournisseurs, EcoPhytoCycle DZ optimise la collecte, le suivi et la
        ...
        <View style={styles.buttonContainer}>
          {/* زر تسجيل الدخول - ينقلك إلى صفحة Login */}
          <TouchableOpacity
          ...
          {/* زر التسجيل - ينقلك إلى صفحة Register */}
          <TouchableOpacity
