...
export default function Register() {
  ...
  <Picker
    ...
    dropdownIconColor="#FFFFFF" // أيقونة السهم بالأبيض
    style={styles.picker}
  >
    {/* يجب إضافة color="#FFFFFF" لكل عنصر */}
    <Picker.Item label="Agriculteur" value="agriculteur" color="#FFFFFF" style={{backgroundColor: "#121414"}} />
    <Picker.Item label="Vendeur" value="vendeur" color="#FFFFFF" style={{backgroundColor: "#121414"}} />
    <Picker.Item label="Collecteur" value="collecteur" color="#FFFFFF" style={{backgroundColor: "#121414"}} />
  </Picker>
</View>
