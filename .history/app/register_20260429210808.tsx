...
const validateForm = () => {
    ...
    if (!phoneRegex.test(form.phone)) {
      Alert.alert("Erreur", "Le numéro de téléphone doit commencer par 05, 06 ou 07 et contenir 10 chiffres.");
      return false;
    }
    if (!passwordRegex.test(form.password)) {
      Alert.alert("Erreur", "Le mot de passe doit contenir au moins 8 caractères (lettres et chiffres).");
      return false;
    }
    if (!form.wilaya) {
