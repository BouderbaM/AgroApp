import { useRouter } from "expo-router"; // استيراد useRouter بدلاً من props
...
const WelcomePage = () => {
  const router = useRouter(); // تعريف الهوك الخاص بالتنقل
    ...
    <SafeAreaView style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.welcomeSection}>
          <Text style={styles.welcomeTitle}>BIENVENUE SUR PhytoCycle</Text>
          <Text style={styles.welcomeDesc}>
            ...
            Algérie. Conçue pour les agriculteurs avec l&#39;appui des
            revendeurs et fournisseurs, PHYTOCYCLE optimise la collecte, le
            suivi et la valorisation de ces déchets, contribuant activement à la
            protection de l&#39;environnement et à une agriculture durable.
            Contribuez à une agriculture durable et à une économie circulaire :
            signalez vos emballages vides, organisez la collecte et suivez leur
            recyclage ! Rejoignez la communauté pour un secteur
        ...
        <View style={styles.card}>
          <Text style={styles.cardMainText}>
            ...
            fournisseurs, PhytoCycle optimise la collecte...
          </Text>
