...
export default function DeclarationsList() {
  ...
  const getColor = (etat: string) => {
    switch (etat) {
      case "Bon":
        return "#2ecc71"; // eco green
      case "Écrasé":
        return "#f59e0b"; // warning waste
      case "Endommagé":
        return "#ef4444"; // rejected waste
      default:
        return "#94a3b8";
    }
  };
    ...
    <View style={styles.card}>
      <View style={styles.cardHeader}>
        <Text style={styles.title}>
          📦 {item.quantite} bidons / Contenance: {item.contenance}
        </Text>
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.topBar}>
        ...
        <View>
          ...
          <Text style={styles.subtitle}>Gestion des collectes</Text>
        </View>

        {/* RIGHT ICONS */}
        <View style={styles.topActions}>
          <TouchableOpacity>
            <Ionicons name="filter-outline" size={20} color="#2ecc71" />
          </TouchableOpacity>
      ...
      <View style={styles.bottomNav}>
        ...
        <TouchableOpacity onPress={() => router.push("/declarations_list")}>
          <Ionicons name="list-outline" size={22} color="#2ecc71"color="#94a3b8" />
        ...
        <TouchableOpacity onPress={() => router.push("/collections_list")}>
          ...
          <Text style={[styles.navText, { color: "#2ecc71" }]}>Collection</Text>
        </TouchableOpacity>
