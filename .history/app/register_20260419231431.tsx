...
export default function Register() {
  ...
  const wilayas = [
    ...
    { label: "52 - Bordj Baji Mokhtar", value: "52" },
              ...
              <View style={styles.popupCard}>
                ...
                <ScrollView style={{ maxHeight: 300 }}>
                  <Text style={styles.popupText}>
                    ...
                    🔥 Éviter le feu et la chaleur{"\n"}
                    🚫 Ne pas réutiliser les flacons{"\n"}
                    ♻️ Déposer dans les points de collecte{"\n"}
                    🧤 Utiliser des gants{"\n\n"}
                    🏪 Pour les Vendeurs {"\n\n"}
                    📢 Sensibiliser les clients{"\n"}
                    📦 Encourager le retour des flacons{"\n"}
                    ⚠️ Stockage sécurisé{"\n"}
...
const styles = StyleSheet.create({
  ...
  label: { color: "#fff", marginTop: 15, marginBottom: 6, fontWeight: "600" },
  ...
  policyCard: { flexDirection: "row", alignItems: "center", marginTop: 15 },
