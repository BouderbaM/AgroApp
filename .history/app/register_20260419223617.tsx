        ...
        <ScrollView contentContainerStyle={styles.scrollContent}>
          ...
          <View style={styles.pickerContainer}>
            <Picker
              ...
              dropdownIconColor="#FFFFFF" // لون السهم الجانبي
              style={styles.picker}
              mode="dropdown" // يجعلها قائمة منسدلة بدلاً من نافذة منبثقة
            >
              {/* ملاحظة: يجب وضع color داخل كل Item لضمان عدم ظهور الخط بالأسود */}
              <Picker.Item
                label="Agriculteur"
                value="agriculteur"
                color="#FFFFFF"
...
const styles = StyleSheet.create({
  ...
  pickerContainer: {
    backgroundColor: "#121414", // لون الخلفية الداكنة
    borderRadius: 8,
    borderWidth: 1,
    borderColor: "#2D3135",
    height: 55, // تحديد ارتفاع ثابت للحاوية
    justifyContent: "center",
    overflow: "hidden",
  },
  picker: {
    width: "100%",
    color: "#FFFFFF", // لون النص المختار
    backgroundColor: "transparent", // لضمان ظهور لون الـ Container
  },
  itemStyle: {
    backgroundColor: "#121414", // خلفية العناصر عند فتح القائمة
    color: "#FFFFFF", // لون خط العناصر
    fontSize: 15,
  },
  policyCard: {
    flexDirection: "row",
