  ...
  return (
    <SafeAreaView style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollContent}>
        {/* Header Section */}
        <Text style={styles.mainTitle}>{t[lang].profile}</Text>

        <View style={styles.infoCard}>
          <View style={styles.infoRow}>
            <Text style={styles.infoLabel}>{t[lang].name}</Text>
            {/* نستخدم || "—" لكي يظهر خط في حال كان الحقل فارغاً في قاعدة البيانات */}
            <Text style={styles.infoValue}>{userData?.nom || "غير مسجل"}</Text>
          </View>

          <View style={styles.infoRow}>
            <Text style={styles.infoLabel}>{t[lang].phone}</Text>
          ...
          <View style={styles.infoRow}>
            <Text style={styles.infoLabel}>Rôle</Text><Text style={styles.infoLabel}>{t[lang].role}</Text><Text style={styles.infoValue}>{userData?.role || "غير مسجل"}</Text>
          </View>
        </View>
        {/* Parameters Section */}
