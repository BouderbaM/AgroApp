    ...
    <View style={styles.card}>
      ...
      <View style={styles.actions}>
        ...
        >
          ...
          <Text style={styles.btnText}>{t[lang].collect}</Text>
        </TouchableOpacity>
        ...
        >
          ...
          <Text style={styles.btnText}>{t[lang].qr}</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.headerBox}>
        <Text style={styles.headerTitle}>♻️ {t[lang].declarationsTitle}</Text>

        <Text style={styles.headerSubtitle}>
          {t[lang].declarationsSubtitle}
        </Text>
      </View>
