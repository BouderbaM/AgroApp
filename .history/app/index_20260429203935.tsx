    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.content}>
        ...
        <Text style={styles.arabicdescription}>
          ...
          للمنتجات التابعة للصحة النباتية في الجزائر. ​تم تصميم تطبيق phytocycle
          للمزارعين بدعم من البائعين والموردين، وهو يعمل على تحسين عمليات الجمع،
          المتابعة، وتثمين هذه النفايات، مما يساهم بشكل فعال في حماية البيئة وفي
          زراعة مستدامة. ​ساهموا في زراعة مستدامة وفي اقتصاد دائري: ​بلغوا عن
          عبواتكم الفارغة. ​نظموا عملية الجمع. ​تابعوا عملية إعادة تدويرها!
          ​انضموا إلى المجتمع من أجل قطاع صيدلة نباتية أكثر خضرة ومسؤولية.
        </Text>
...
const styles = StyleSheet.create({
  ...
  arabicdescription: {
    textAlign: "right", // لضمان محاذاة النص لليمين
    writingDirection: "rtl", // خاص بنظام iOS لضبط اتجاه الأحرف والرموز
    fontSize: 16,
    color: "#a0a0a0",
    lineHeight: 22,
    marginBottom: 40,
