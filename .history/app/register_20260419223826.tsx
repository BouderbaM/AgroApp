...
export default function Register() {
  ...
  >
    ...
    <Picker.Item label="Agriculteur" value="agriculteur" color="#FFFFFF" style={styles.itemStyle} />
    <Picker.Item label="Vendeur" value="vendeur" color="#FFFFFF" style={styles.itemStyle} />
    <Picker.Item label="Collecteur" value="collecteur" color="#FFFFFF" style={styles.itemStyle} />
  </Picker>
</View>
